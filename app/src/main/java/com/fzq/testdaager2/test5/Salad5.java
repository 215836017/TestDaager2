...
//      saladComponent.inject(this);//将saladComponent所连接的SaladModule中管理的依赖注入本类中
        ...
        Log.i("Salad5.java", "orange1 -- " + orange1.toString());
        Log.i("Salad5.java", "orange2 -- " + orange2.toString());

        Log.i("Salad5.java", "我在搅拌制作水果沙拉 -- 11111");
